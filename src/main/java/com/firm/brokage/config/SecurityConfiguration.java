...
import com.firm.brokage.model.UserRole;
        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> {
                    authorize.requestMatchers(antMatcher("/swagger-ui/**"),
                            ...
                            .requestMatchers(antMatcher(HttpMethod.POST, "/assets")).hasRole(UserRole.ADMIN.name())
                            .requestMatchers(antMatcher(HttpMethod.POST, "/orders")).hasRole(UserRole.ADMIN.name())
